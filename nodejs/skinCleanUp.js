...
function manageAllSkins(EachFormformjs,callback){
...
function printKeyValuePair(skinsArray,printUniqueArray,callbackCounter)
{
	callbackCounter++;
	skinsArray.forEach(function(item){
	 ...
	 console.log("total number of used skins-->" + callbackCounter)
