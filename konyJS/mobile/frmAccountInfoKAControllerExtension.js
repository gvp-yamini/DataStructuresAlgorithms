/*
 * Controller Extension class for frmAccountInfoKA
...
kony.sdk.mvvm.frmAccountInfoKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
    ...
    fetchData: function() {
        try {
            ...
            if(!kony.retailBanking.globalData.globals.DoReloadEditAccountInfo){
              populatingAccountsInfoScreen(true);  
            }else{
  ...
  navigateToAccountsInfoEdit: function(){
