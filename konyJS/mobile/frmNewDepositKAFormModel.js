/*
 * FormModel class for frmNewDepositKA
 ...
 * @class frmNewDepositKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmNewDepositKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmNewDepositKAFormModel#
     */
    clear: function() {
