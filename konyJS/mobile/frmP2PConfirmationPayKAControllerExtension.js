/*
 * Controller Extension class for frmP2PConfirmationPayKA
 ...
 * @class frmP2PConfirmationPayKAControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmP2PConfirmationPayKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof frmP2PConfirmationPayKAControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    bindData: function(data) {
        try {
            ...
            formmodel.setViewAttributeByProperty("transactionDate","text",record.transactionDate);
          var title= i18n_pay+kony.retailBanking.util.formatingAmount.appendingCurrencyCodeToAmount(record.amount,kony.retailBanking.globalData.globals.CurrencyCode);
    ...
    saveData: function() {
        ...
        function success(res) {
          ...
          navObject.setCustomInfo("TransactionID",res.referenceId);
         // kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
          listController.performAction("navigateTo",["frmSuccessFormKA",navObject]);
        }
