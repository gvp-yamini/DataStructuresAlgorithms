/*
 * FormModel class for frmNewMessageKA
 ...
 * @class frmNewMessageKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmNewMessageKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmNewMessageKAFormModel#
     */
    clear: function() {
