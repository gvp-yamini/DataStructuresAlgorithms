/*
 * Controller Extension class for frmMyMoneyListKA
 ...
 * @class frmMyMoneyListKAControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmMyMoneyListKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof frmMyMoneyListKAControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    processData: function(data) {
        try {
            ...
            return  mymoneyaccountsList(processedData,"segAccountsKA");
        } catch (err) {
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
    ...
    bindData: function(data) {
        try {
            ...
            if(data["segAccountsKA"]["segAccountsKA"].getData() && data["segAccountsKA"]["segAccountsKA"].getData().length > 0){
              kony.retailBanking.globalData.globals.PFM_ACCOUNTS_PRESENT = true;
              ...
              kony.retailBanking.globalData.globals.PFM_ACCOUNTS_PRESENT = false;
            ...
            getUncategorisedTransactionCount(successCallBack,errorCallback);
