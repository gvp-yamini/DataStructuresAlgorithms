/*
 * FormModel class for frmNewTransferKA
 ...
 * @class frmNewTransferKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmNewTransferKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmNewTransferKAFormModel#
     */
    clear: function() {
