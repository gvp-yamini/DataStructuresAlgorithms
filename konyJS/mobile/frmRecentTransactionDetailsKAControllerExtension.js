 ...
 */
kony.sdk.mvvm.frmRecentTransactionDetailsKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
  ...
  fetchData: function() {
    try {
      ...
      var tempData = {};
      tempData = navigationObject.getCustomInfo("selectedTransactionObj");
      ...
      /* Not sure what this does, but didn't want to break anything */
