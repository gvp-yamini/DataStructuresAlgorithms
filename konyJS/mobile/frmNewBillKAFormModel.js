/*
 * FormModel class for frmNewBillKA
 ...
 * @class frmNewBillKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmNewBillKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmNewBillKAFormModel#
     */
    clear: function() {
