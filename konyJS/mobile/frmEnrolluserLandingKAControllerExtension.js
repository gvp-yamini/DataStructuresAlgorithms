...
kony.sdk.mvvm.frmEnrolluserLandingKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
    ...
    saveData: function() {
        try {
			...
			var dob = formModel.getViewAttributeByProperty("calDob","dateComponents");
            dob = getDateFromdateObj(dob);
			formModel.setViewAttributeByProperty("lblDobKA","text",dob);
            //var navData = this.getController().getContextData();
            //navData.setOperationType(kony.sdk.mvvm.OperationType.ADD,"form");
