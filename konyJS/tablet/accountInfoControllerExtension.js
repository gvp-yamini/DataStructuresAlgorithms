/*
 * Controller Extension class for accountInfo
 ...
 * @class frmAccountInfoKAControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.accountInfoControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
     ...
     * @memberof frmAccountInfoKAControllerExtension#
     */
    fetchData: function() {
        try {
            ...
            if( controllerContextData && controllerContextData.getCustomInfo("selectedAccountObj")){
                 ...
                 this.accId = accountData["accountID"];
             }
             accountsInfoPreShowskins();
            if(!kony.retailBanking.globalData.globals.DoReloadEditAccountInfo){
              populatingAccountsInfoScreen();  
            }else{
    ...
    bindData: function(data) {
        try {
            ...
            populatingAccountsInfoScreen(false);
