/*
 * FormModel class for frmRegisterKA
 ...
 * @class frmRegisterKAFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.frmRegisterKAFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof frmRegisterKAFormModel#
     */
    clear: function() {
