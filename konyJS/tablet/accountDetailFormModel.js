/*
 * FormModel class for accountDetail
 ...
 * @class accountDetailFormModel
 * @param {Object} controller - Form Controller.
 */
kony.sdk.mvvm.accountDetailFormModel = Class(kony.sdk.mvvm.BaseFormModel, {
     ...
     * @memberof accountDetailFormModel#
     */
    clear: function() {
