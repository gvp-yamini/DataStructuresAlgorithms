...
function SetPaybillPrefereedAccount(){
  var INSTANCE = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
  ...
  if (preferedSelAcnt !==""){
         ...
         if(nickNameData.trim() === "")
              ...
              viewModel.setViewAttributeByProperty("fromAmountPick","text",preferedSelAcnt.availableBalance.text);
...
function newConfirmAccountPayBill(fromForm,toForm)
{
  ...
  if((fromAccNumber !== "" && fromAccNumber!=null) && (toAccNumber !== "" && toAccNumber!=null)){
  amount = amount;
      ...
      }else //if((Number(amount)<=Number(fromAccountBal)))
      {
	   ...
	   if(frmRecentTransactionDetailsKA.repeatTransactionButton.text == "Repeat Bill Pay"){
          navigationObject.setDataModel(null,kony.sdk.mvvm.OperationType.ADD, "form");
        }
		*/
  ...
  }else if((fromAccNumber !=="" && fromAccNumber != null) && (toAccNumber === "" || toAccNumber==null)){
 ...
 frmBillDetailsKA.lblSelectedRowIndexKA.text = selctedIndex;
  ...
  if(segName === "segScheduledTransactionsKA"){
      ...
      frmBillDetailsKA.lblTransactionIdKA.text = paybillScheduledList[selctedIndex].transactionId;
		if(userAgent === "iPhone")
        {
          frmBillDetailsKA.flxTransferPayTitleLabelKA.text=i18n_outStandingBalance+" ";
        }
        else
        {
          frmBillDetailsKA.flxAndroidTitleLabelKA.text=i18n_outStandingBalance+" ";
        }
   }else{
    frmBillDetailsKA.lblNotesKA.text = i18n_transactionDateC;
...
function repeatCompletedBillPay(){
 /* var selectedIndex =kony.retailBanking.globalData.selectedPayeeDetails.getSelectedPayeeDetails();
  var selectedIndex = frmBillDetailsKA.lblSelectedRowIndexKA.text;
   RecentTransferSwitching(paybillCompletedList[selectedIndex]);
   RecentTransferSwitching(selectedIndex);
   */
	managePayeeBillPay();
}
...
// 			}
             ...
             alert(i18n_AccountMismatchAlert);
   }
...
function setDateFormatforNewBillPay()
{
  var id = frmNewBillKA.lblTransactionIdKA.text;
  if(!(id !== null && id !=="")){
  ...
  var startdate=[day,month,year];
  var endDate = [day,month,year+1];
  frmNewBillKA.lblCurrencyType.text=kony.retailBanking.util.formatingAmount.appendingCurrencyCodeToAmount(0,kony.retailBanking.globalData.globals.CurrencyCode).slice(0,1);
  frmNewBillKA.calDateKA.validStartDate=startdate;
  frmNewBillKA.calDateKA.validEndDate=endDate;
  frmNewBillKA.calDateKA.dateComponents = [parseFloat(day), parseFloat(month), parseFloat(year), 0.0, 0.0, 0.0];
  ...
  var month2,day2;
      ...
      var scheduledDate2 = kony.retailBanking.util.formatingDate.getApplicationFormattedDateKA(formattedDate);
 	  frmNewBillKA.lblTransferDateKA.text = scheduledDate2; 
  }
}
...
function EditPayBillTransfer(tempdata){
  ...
  frmNewBillKA.transferPayTitleLabel.text=i18n_editTransfer;
  ...
  frmNewBillKA.flxTransferNotes.setVisibility(true);
    ...
    frmNewBillKA.calDateKA.dateComponents = [parseFloat(day), parseFloat(month), parseFloat(year), 0.0, 0.0, 0.0];
      ...
      var scheduledDate2 = kony.retailBanking.util.formatingDate.getApplicationFormattedDateKA(formattedDate);
       ...
       if(frmName == "frmTransferPayLandingKA")
        { 
         frmNewBillKA.lblTransactionIdKA.text = accountTransactionDetails.transactionId.text; 
        }else if(frmName == "moreLanding"){
          frmNewBillKA.lblTransactionIdKA.text = tempdata.transactionId;
        }
    }else{
        //frmNewBillKA.calDateKA.dateComponents = [parseFloat(day), parseFloat(month), parseFloat(year), 0.0, 0.0, 0.0];		
 ...
 frmNewBillKA.lblCurrencyType.text=kony.retailBanking.util.formatingAmount.appendingCurrencyCodeToAmount("",kony.retailBanking.globalData.globals.CurrencyCode); 
  ...
  frmNewBillKA.lblTransferNotes.text = tempdata.transactionsNotes;
  ...
  if (accountType === kony.retailBanking.globalData.globals.Checking){
         frmNewBillKA.amountAccountOne.text = "Available Balance";
         ...
         frmNewBillKA.amountAccountOne.text = "Current Balance";
...
function formatTransferDatePaybill(){
      var scheduledDate = frmNewBillKA.calDateKA.dateComponents;
    var month,day;
...
function setDateFormatforPaybill()
{
...
function navigateToPayBillConfirmPageTablet(dataMap){
      ...
      frmConfirmTransferKA.transactionAmount.text= kony.retailBanking.util.formatingAmount.appendingCurrencyCodeToAmount(dataMap[0].amount);
  	  frmConfirmTransferKA.transactionDate.text = i18n_transferTo;
      ...
      frmConfirmTransferKA.lblScheduledDate.text= dataMap[0].scheduledDate;
  	  //frmConfirmTransferKA.CopynotesWrapper03de47f39b8bc46.setVisibility(false);
...
function cancelBillPay(){
 // var prevForm = kony.application.getPreviousForm().id;
 var prevForm = kony.retailBanking.globalData.transfers.getTransferMainForm();
 /* if(prevForm === "frmTransferPayLandingKA"){
     getTransferPayLandingForm("frmTransferPayLandingKA");
  }else if(prevForm === "moreLanding"){
    var INSTANCE = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
    var controller = INSTANCE.getFormController("moreLanding");
    controller.getFormModel().showView();
  }*/
  if(prevForm === "transferPayLanding"){
     getTransferPayLandingForm("frmTransferPayLandingKA");
  }else if(prevForm === "moreLanding"){
    var INSTANCE = kony.sdk.mvvm.KonyApplicationContext.getAppInstance();
    var controller = INSTANCE.getFormController("moreLanding");
  ...
  kony.retailBanking.globalData.transfers.setTransferMainForm("");
}
