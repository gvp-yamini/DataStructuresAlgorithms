/*
 * Controller Extension class for frmNewPayPersonKA
 ...
 * @class frmNewPayPersonKAControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmNewPayPersonKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof frmNewPayPersonKAControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    bindData: function(data) {
        try {
			...
			if(typeof(record.fromForm)!= undefined && record.fromForm=="frmTransferPayLandingKA")
            {
              formmodel.setViewAttributeByProperty("amountTextField","text","");
              formmodel.setViewAttributeByProperty("noteTextFieldLabel","text","");
            }
          else if(typeof(record.fromForm)!= undefined && record.fromForm=="frmP2PConfirmTransferKA")
            {
              formmodel.setViewAttributeByProperty("amountTextField","text",record.amount);
              formmodel.setViewAttributeByProperty("noteTextFieldLabel","text",record.notes);
            }
            this.getController().getFormModel().formatUI();
          setPreferredAccountToP2P();
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
