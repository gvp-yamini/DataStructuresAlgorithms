/*
 * Controller Extension class for frmConfirmDeposit
 ...
 * @class frmConfirmDepositControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.frmConfirmDepositControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof frmConfirmDepositControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    saveData: function() {
        try {
            ...
            var date=new Date();
			date = kony.retailBanking.util.formatingDate.getApplicationFormattedDateTime(date, kony.retailBanking.util.BACKEND_DATE_TIME_FORMAT);
        ...
        function error(err) {
          ...
          frmDepositSuccessKA.successText.text = i18n_transactionFailed;
           frmDepositSuccessKA.successTitle.text = i18n_FailedMsg;
