...
kony.sdk.mvvm.frmP2PConfirmTransferKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
    ...
    bindData: function(data) {
        try {
            ...
            formmodel.setViewAttributeByProperty("toAccountNumberKA","text", record.toAccountNumberKA);
          	formmodel.setViewAttributeByProperty("transactionFrom","text", record.accountName);
            if(record.referenceId!== "")
              formmodel.setViewAttributeByProperty("referenceId","text", record.referenceId);
            formmodel.setViewAttributeByProperty("payeeName","text", record.payeeName);
