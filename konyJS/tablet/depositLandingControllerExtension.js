/*
 * Controller Extension class for depositLanding
 ...
 * @class depositLandingControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.depositLandingControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof depositLandingControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
    ...
    bindData: function(data) {
        try {
          ...
          formmodel.setViewAttributeByProperty("lblCurrencyType","text",kony.retailBanking.util.formatingAmount.appendingCurrencyCodeToAmount("",kony.retailBanking.globalData.globals.CurrencyCode));
           formmodel.performActionOnView("toCardTitle","setVisibility",[false]);
           formmodel.performActionOnView("toCardInner","setVisibility",[false]);
           formmodel.performActionOnView("toAccountPick","setVisibility",[true]); 
          ...
          {
             formmodel.performActionOnView("toCardTitle","setVisibility",[true]);
             formmodel.performActionOnView("toCardInner","setVisibility",[true]);
             formmodel.performActionOnView("toAccountPick","setVisibility",[false]);
          }
          formmodel.performActionOnView("amountAccountOne","setVisibility",[true]);
          formmodel.performActionOnView("toAmountPick","setVisibility",[true]);
         formmodel.setViewAttributeByProperty("confirmTransaction","skin","primaryActionDisabled");
         formmodel.performActionOnView("lblCurrencyType","text",kony.retailBanking.globalData.globals.CurrencyCode);
          formmodel.setViewAttributeByProperty("lblBankNameHeader","text",kony.retailBanking.globalData.globals.BankName);
         formmodel.setViewAttributeByProperty("lblToAccountBankNameKA","text",kony.retailBanking.globalData.globals.BankName);
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
