...
function setDataMapCallBack(response){
  ...
  if(locationList.length ==0){ 		 
    ...
    kony.ui.Alert(i18n_noatmorBranchesFound,null,constants.ALERT_TYPE_INFO,i18n_ok,"","");
    if(frmLocatorKA.locatorSearchTextField.text!= null && frmLocatorKA.locatorSearchTextField.text !=""){
...
function onClickdetails(){
  ...
  if(gblPinClickDetails.type=="ATM"){
    ...
    frmLocatorATMDetailsKA.getDirectionsButton.setVisibility(true);
      ...
      frmLocatorATMDetailsKA.distance.text=i18n_DistanceUnknown;
...
function searchRouteSuccesCallback(routes)
{
  ...
  if(routes == null || routes.length == 0){
    kony.application.dismissLoadingScreen();
     ...
     kony.ui.Alert(i18n_noDirections,null,constants.ALERT_TYPE_INFO,i18n_ok,"","");
  } else
    {
...
function displaySearchRoutes1(routes){
...
function drawRoute1(routeid,polyPoints,color)
{
...
function setDirectionStepsData1(resultTable){
  ...
  if(resultTable && resultTable[0]){
                ...
                var defaultRoutes =i18n_defaultDirectionListVA;
...
function getDirectionImage1(key,value){
  var keyOccurredAt = -1;
