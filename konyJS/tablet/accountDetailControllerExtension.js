/*
 * Controller Extension class for accountDetail
 ...
 * @class accountDetailControllerExtension
 * @param {Object} controllerObj - Form Controller.
 */
kony.sdk.mvvm.accountDetailControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
     ...
     * @memberof accountDetailControllerExtension#
     */
    fetchData: function() {
        try {
            var scopeObj = this;
        ...
        function success(response) {
              ...
              var navigationObject = controller && controller.getContextData();
              navigationObject.setCustomInfo("transactionSegment",response.transactionSegment);
         	 //var tempdata=setTransferListData(response,"transactionSegment");
           	 //response.transactionSegment=tempdata[0];
             // navigationObject.setCustomInfo("transactionSegment",response.transactionSegment);
    ...
    processData: function(data) {
        try {
            var scopeObj = this;
           // var tempdata=setTransferListData(data,"transactionSegment");
...
//             return processedData;
    ...
    bindData: function(data) {
        try {
          ...
          kony.print(accountDetail.transactionSegment.data);
          populateAccountDetailsinAccountDetails("accountDetail");
