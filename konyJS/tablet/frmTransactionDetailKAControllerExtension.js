...
kony.sdk.mvvm.frmTransactionDetailKAControllerExtension = Class(kony.sdk.mvvm.BaseFormControllerExtension, {
  ...
  fetchMasterData: function(serviceName, options, successcallback, errorcallback) {
    ...
    getPickListValues : function(pickListInfo,widgetId,successcallback, errorcallback){
        ...
        function success(response){
			if(response){
                ...
                var toAppend = i18n_select+ " " +frmConfigClassObj[widgetId].fieldprops.selector ;
    ...
    bindData: function(data) {
        try {
            ...
            formmodel.setViewAttributeByProperty("lblTransactionAmountKA","text",formattedAmount);
            formmodel.setViewAttributeByProperty("lblTransactionDateKA","text",formattedDate);
            ...
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
              if (!moreLanding.flxTransactionDetailsWrapperKA){
      			moreLanding.add(frmTransactionDetailKA.flxTransactionDetailsWrapperKA);
    			moreLanding.flxTransactionDetailsWrapperKA.left = "100%";
                moreLanding.flxTransactionDetailsWrapperKA.width = leftContainerWidth;
  ...
  getRecordsDataMapforTransactionDetails: function(){
    return this.getRecordsDataMap();
  },
  ...
  if (userAgent == "iPhone" || userAgent ==="iPad"){
    ...
    if(frmTransactionDetailKA.CopyaccountPreviewEnableSwitch0b4fab801c08546.selectedIndex==1){
     ...
     if(frmTransactionDetailKA.CopyCheckBoxGroup0d9fa019582e647.selectedKeys && frmTransactionDetailKA.CheckBoxGroup0aebf676b3db246.selectedKeys[0]=="true"){
         formmodel.setWidgetData("hiddenIncludeInAnalysis","true");
    }else{
        formmodel.setWidgetData("hiddenIncludeInAnalysis","false");
    }
