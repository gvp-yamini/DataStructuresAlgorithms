...
kony.retailBanking = {
    ...
    onClickMonthOverview: function(args) {
        ...
        function success() {
            ...
            frmMyMoneyKA.flxMonthlySpendingKAinner.add(pieChart);
    ...
    settingSpecificMonth: function(Month) {
        ...
        frmMyMoneyKA.lblSelectedMonthSpendingKA.text = " > " + Month;
        frmMyMoneyKA.flxMonthlySpendingKA.isVisible = false;
	    frmMyMoneyKA.flxSelectedMonthSpendingKA.isVisible = true;
 	    frmMyMoneyKA.lblSelectedMonthSpendingKA.isVisible = true;
    },
    settingSpecificTransactionList: function(categoryName, categoryID) {
        ...
        function success() {
            frmMyMoneyKA.lblShoppingKA.text = " > " + categoryName;         
            frmMyMoneyKA.lblMonthlySpendingKA.skin = sknMonthlySpending3278E6KA;
