...
kony.sdk.mvvm.frmAddNewPayeeKAControllerExtension = Class(kony.sdk.mvvm.BankingAppControllerExtension, {
    ...
    bindData: function(data) {
        try {
           ...
           if(! formmodel.getWidgetData("tbxCompanyNameKA").getData()){
               frmAddNewPayeeKA.tbxCompanyNameKA.text="";
            }
            if(! formmodel.getWidgetData("tbxNickNameKA").getData()){
               frmAddNewPayeeKA.tbxNickNameKA.text="";
            }
            if(! formmodel.getWidgetData("tbxAccKA").getData()){
               frmAddNewPayeeKA.tbxAccKA.text="";
            }
            if(! formmodel.getWidgetData("tbxAddress1KA").getData()){
               frmAddNewPayeeKA.tbxAddress1KA.text="";
            }
            kony.sdk.mvvm.KonyApplicationContext.dismissLoadingScreen();
    ...
    validateNewAccountMobile:function(){
            ...
            if(validated){
              if(formmodel.getWidgetData("tbxAccKA").getData()==frmAddNewPayeeKA.tboxReenterAccountNumberKA.text){
                  validated = true;
              }else{
                validated = false;
              }
